...
//        magic(" ----------------------------> \(self.description) is initialized")
    ...
    convenience init(withFromPosition fromPosition: Position, inDirection: Direction? = nil) {
        /** Presenting view */
        self.init()
    ...
    convenience init(withToPosition toPosition: Position, outDirection: Direction? = nil) {
        /** Dismissing view */
        self.init()
    ...
    func animateTransition( transitionContext: UIViewControllerContextTransitioning) {
        guard let presentedView = transitionContext.viewForKey(UITransitionContextToViewKey) else { fatalError("Error setting up presentedView in BouncyViewControllerAnimator") }
